...
describe("new payment", () => {
  ...
  it("should create a new payment", async () => {
    ...
    .send({promptpayID:"0967825577", appointmentID:"6603aab890e39a9c8f3be441", status:"VERIFYING"})
    ...
    .then(response => {
      ...
      expect(JSON.stringify(response._body.data.status)).toEqual(JSON.stringify("VERIFYING"))
    });
  })
})