...
export default function LeftMemberCard({
  Name,
  role,
  description,
  workList,
  ...
  return (
    <div className="w-full px-[14%] py-[3%] flex flex-col">
      <div className="pt-[120px]">
        <div className="w-full flex flex-row space-x-5 justify-start items-center">
      ...
      <div className="flex flex-row items-center justify-center">
        ...
        <div className="text-xl w-[30%] ml-[10%] mt-2 pt-10">
