export default function Announcement(){
    return (
        <div className="bg-cadetblue rounded-[20px] py-2 px-10 my-10 w-[40%] flex flex-col h-full">
            <div className="flex flex-row">
            <div className="text-4xl font-bold my-10 text-left">Announcement</div>
            <svg className="my-10 ml-[30%]" width="41" height="39" viewBox="0 0 41 39" fill="none" xmlns="http://www.w3.org/2000/svg">
